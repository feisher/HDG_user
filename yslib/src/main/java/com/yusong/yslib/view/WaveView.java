...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#2840C4FF");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3C80D8FF");
    ...
    protected void onDraw(Canvas canvas) {
        // 根据mShowWave状态修改油漆着色器
        if (mShowWave && mWaveShader != null) {
            // 在mShowWave之后，把它分配给我们的油漆
            if (mViewPaint.getShader() == null) {
                mViewPaint.setShader(mWaveShader);
            }

            // 根据mWaveLengthRatio和mAmplitudeRatio来分析
            // this decides the size(mWaveLengthRatio for width, mAmplitudeRatio for height) of waves
            mShaderMatrix.setScale(mWaveLengthRatio / DEFAULT_WAVE_LENGTH_RATIO,
